...
function VastInvocationShow ( domain_id, ad_id ) {
	...
	$.post( basePath + "/publisher/zone/" + domain_id + "/generatevasttag", { ad_id: ad_id }, function( data ) {
...
function del_website(self, websiteid) {
	...
	$.post(basePath + "/users/deletewebsite", { q: 1, website_id: websiteid }, function( data ) {
...
function web_appr_denie_confirm() {
	...
	$.post(basePath + "/websites/approvedenied", { q: q, website_ids: ids, description:description }, function( data ) {
