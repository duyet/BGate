...
class PublisherAdZoneType extends AbstractTableGateway
{
	...
	public static function get_instance() {
		...
		if (self::$instance == null):
			self::$instance = new \_factory\PublisherAdZoneType();
		endif;
    ...
    function __construct() {
            ...
            $this->table = 'PublisherAdZoneType';
    ...
    public function get_row($params = null) {
        ...
        $resultSet = $this->select(function (\Zend\Db\Sql\Select $select) use ($params) {
        	...
        	endforeach;
        	$select->limit(1, 0);
        	$select->order('PublisherAdZoneTypeID');
